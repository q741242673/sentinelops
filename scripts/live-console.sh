...
export SENTINELOPS_MODEL_NAME="${SENTINELOPS_MODEL_NAME:-deepseek-v4-flash}"
...
export SENTINELOPS_DEMO_ENABLED=true
export SENTINELOPS_DEMO_NAMESPACE=sentinelops-demo
